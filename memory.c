...
void memory_region_init_ram(MemoryRegion *mr,
                            ...
                            uint64_t size)
{
    printf("memory_region_init_ram %ld IN\n",size);
	memory_region_init(mr, name, size);
    mr->ram = true;
    mr->terminates = true;
    mr->destructor = memory_region_destructor_ram;
    mr->ram_addr = qemu_ram_alloc(size, mr);
	printf("memory_region_init_ram %ld OUT\n",size);
}
...
void memory_region_init_ram_ptr(MemoryRegion *mr,
                                ...
                                void *ptr)
{
    printf("memory_region_init_ram_ptr IN\n");
	memory_region_init(mr, name, size);
    mr->ram = true;
    mr->terminates = true;
    mr->destructor = memory_region_destructor_ram_from_ptr;
    mr->ram_addr = qemu_ram_alloc_from_ptr(size, ptr, mr);
	printf("memory_region_init_ram_ptr OUT\n");
}
...
void memory_region_init_rom_device(MemoryRegion *mr,
                                   ...
                                   uint64_t size)
{
    printf("memory_region_init_rom_device IN\n");
	memory_region_init(mr, name, size);
    mr->ops = ops;
    mr->opaque = opaque;
    mr->terminates = true;
    ...
    mr->ram_addr = qemu_ram_alloc(size, mr);
	printf("memory_region_init_rom_device OUT\n");
}

...
ram_addr_t qemu_ram_alloc_from_ptr(ram_addr_t size, void *host,
                                   MemoryRegion *mr)
{
    printf("qemu_ram_alloc_from_ptr %ld IN\n",size);
	RAMBlock *new_block;
    ...
    QLIST_INSERT_HEAD(&ram_list.blocks, new_block, next);//add new_block(main RAM is the first element) into ram_list.block
	...
	printf("------------------------HOST:%ld;size:%ld,offset:%ld\n",new_block->host,new_block->length,new_block->offset);
	mr->host_v_addr=(ram_addr_t)(new_block->host);
	printf("qemu_ram_alloc_from_ptr %ld OUT\n",size);
	return new_block->offset;
}

ram_addr_t qemu_ram_alloc(ram_addr_t size, MemoryRegion *mr)
{
    printf("qemu_ram_alloc %ld IN\n",size);
	printf("qemu_ram_alloc %ld OUT\n",size);
